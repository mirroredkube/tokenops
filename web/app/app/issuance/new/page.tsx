    ...
    <CanCreateIssuances fallback={
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">You don't have permission to create issuances. Only Administrators and Issuer Admins can create issuances.</p>
        </div>
      </div>
    }>
